package com.example.jobfinder.vnpay;
...
public class VnPayConfiguration {
    ...
    public static final String RETURN_URL = "http://localhost:8080/upgrade-vip/order-status";
    ...
    public static String getSecureHash(Map<String, String> params){
        StringBuilder hashData = new StringBuilder("");
        Set<String> keys = params.keySet();
        boolean isFirst = true;
        for(String paramName : keys){
